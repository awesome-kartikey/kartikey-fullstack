...
export function SortableList({ initialTasks }: { initialTasks: Task[] }) {
  ...
  const [prevInitialTasksCount, setPrevInitialTasksCount] = useState(initialTasks.length);

  if (initialTasks.length !== prevInitialTasksCount) {
    setTasks(initialTasks);
    setPrevInitialTasksCount(initialTasks.length);
  }
